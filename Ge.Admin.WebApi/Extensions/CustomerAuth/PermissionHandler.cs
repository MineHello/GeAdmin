...
namespace Ge.Admin.WebApi.Extensions.CustomerAuth
{
    ...
    public class PermissionHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public PermissionHandler(IAuthenticationSchemeProvider schemes, IRoleModulePermissionService roleModulePermissionServices,IHttpContextAccessor httpContextAccessor)
        {
            Schemes = schemes;
